...
| **Grupo** | **Hostname** | **Rede LAN** | **IP do Roteador** | **DHCP Server** | **Wi-Fi 2.4 GHz** | **Wi-Fi 5 GHz** | **Wi-Fi Convidado** | **Romaning** |
| :-------: | ------------ | ------------ | ------------------ | --------------- | ----------------- | --------------- | ------------------- | -------------|
| **01** | `ap-grupo-01` | `172.16.100.0/24` | `172.16.100.254/24` | `172.16.100.100 – 172.16.100.150` | `grupo-01-2.4` | `grupo-01-5.0` | `guest-grupo-01-5.0` | `grupo-01` |
| **02** | `ap-grupo-02` | `172.16.110.0/24` | `172.16.110.254/24` | `172.16.110.100 – 172.16.110.150` | `grupo-02-2.4` | `grupo-02-5.0` | `guest-grupo-02-5.0` | `grupo-02` |
| **03** | `ap-grupo-03` | `172.16.120.0/24` | `172.16.120.254/24` | `172.16.120.100 – 172.16.120.150` | `grupo-03-2.4` | `grupo-03-5.0` | `guest-grupo-03-5.0` | `grupo-03` |
| **04** | `ap-grupo-04` | `172.16.130.0/24` | `172.16.130.254/24` | `172.16.130.100 – 172.16.130.150` | `grupo-04-2.4` | `grupo-04-5.0` | `guest-grupo-04-5.0` | `grupo-04` |
| **05** | `ap-grupo-05` | `172.16.140.0/24` | `172.16.140.254/24` | `172.16.140.100 – 172.16.140.150` | `grupo-05-2.4` | `grupo-05-5.0` | `guest-grupo-05-5.0` | `grupo-05` |
| **06** | `ap-grupo-06` | `172.16.150.0/24` | `172.16.150.254/24` | `172.16.150.100 – 172.16.150.150` | `grupo-06-2.4` | `grupo-06-5.0` | `guest-grupo-06-5.0` | `grupo-06` |
| **07** | `ap-grupo-07` | `172.16.160.0/24` | `172.16.160.254/24` | `172.16.160.100 – 172.16.160.150` | `grupo-07-2.4` | `grupo-07-5.0` | `guest-grupo-07-5.0` | `grupo-07` |
| **08** | `ap-grupo-08` | `172.16.170.0/24` | `172.16.170.254/24` | `172.16.170.100 – 172.16.170.150` | `grupo-08-2.4` | `grupo-08-5.0` | `guest-grupo-08-5.0` | `grupo-08` |
---
