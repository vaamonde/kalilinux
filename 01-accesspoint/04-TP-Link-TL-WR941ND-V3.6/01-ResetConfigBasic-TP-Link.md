...
> **Equipamentos homologados:** TP-Link TL-WR941N/ND (US)
---
...
| **Versão** | 0.04 |
| **Equipamentos testados** | TP-Link TL-WR941N/ND (US) |
---
...
|--------|--------------|------------|-----------|--------|
| **TP-Link TL-WR941N/ND (US)** | Wi-Fi 4 — 802.11n | TL-WR941N/ND | [📄 Datasheet](https://static.tp-link.com/res/down/doc/TL-WR941ND_DS.pdf) | [📘 Manual de Instalação](https://static.tp-link.com/upload/manual/2022/202201/20220107/7106509418_SOHO%20router(America-4Languages)_QIG_V1.pdff) |
---
...
> ⚠️ **Atenção:** o modelo **TP-Link TL-WR941N/ND (US)** não tem o Botão __`Liga e Desligada`__ e utiliza Fonte de **9V**
---
...
## 02 - Testando a Conexão de Rede do Access Point TP-Link 300M
...
| Passo | Ação |
|-------|------|
| 1 | Executar o comando: `ping 192.168.1.1` |
---
...
## 03 - Acessando via Web Browser o Access Point TP-Link 300M
...
| Endereço de acesso | `http://192.168.1.1` |
---

### 🔐 02. Usuário e senha padrão
...
### 🌐 04. Quick Setup - WAN Connection Type

| Campo | Valor |
|-------|-------|
| **Connection WAN** | `(ON) Dynamic IP` |
---
...
### 📶 06. Quick Setup - Wireless

| Configuração | Status |
|--------------|--------|
| **Wireless Radio** | 🔴 `Disable (OFF)` |
| **Wireless Security** | 🔴 `Disable (OFF)` |
---
...
### ⏳ 07. Quick Setup - Finish

➡️ Clicar em **`Reboot`** and **OK**
---
...
- [ ] Acesso à interface web (`192.168.1.1`) realizado
