...
```bash
# No terminal, dentro da pasta onde a ISO foi baixada se estiver utilizado o Linux
...
### 🔧 Procedimento (Instalação Gráfica Padrão - Mais Fácil - Sem Complicação)
...
### 🔄 Fazer a Atualização Completa do Sistema Operacional
...
### ✅ Testes de Validação Pós Atualização do Sistema
...
## 05 - Configuração Básica Pós-Instalação do Kali Linux
...
### 🕒 Conferindo o Fuso Horário do Sistema Operacional Kali Linux
...
## 06 - Instalação e Verificação das Antenas Wi-Fi Externas USB no Kali Linux
